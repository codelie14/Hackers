...
class ToolsRegistry {
  ...
  static const List<ToolModel> all = [
    ...
    ToolModel(id: 'bcrypt_hash', name: 'Bcrypt Hash', description: 'Generate and verify Bcrypt password hashes with configurable cost factor.', category: ToolCategory.crypto, icon: Icons.enhanced_encryption, tags: ['bcrypt', 'password', 'hash'], isAvailable: true, routePath: '/category/crypto/bcrypt_hash'),
    ...
    ToolModel(id: 'salt_generator', name: 'Salt Generator', description: 'Generate cryptographically secure random salts of configurable length.', category: ToolCategory.crypto, icon: Icons.grain, tags: ['salt', 'random', 'crypto'], isAvailable: true, routePath: '/category/crypto/salt_generator'),
    ...
    ToolModel(id: 'chacha20_tool', name: 'ChaCha20-Poly1305', description: 'Encrypt and decrypt using ChaCha20-Poly1305 AEAD cipher.', category: ToolCategory.crypto, icon: Icons.lock_outline, tags: ['chacha20', 'poly1305', 'encrypt'], isAvailable: true, routePath: '/category/crypto/chacha20_tool'),
    ...
    ToolModel(id: 'pronounceable_pwd', name: 'Pronounceable Password', description: 'Generate passwords that are easier to remember while staying secure.', category: ToolCategory.password, icon: Icons.record_voice_over_outlined, tags: ['password', 'pronounceable', 'memorable'], isAvailable: true, routePath: '/category/password/pronounceable'),
    ToolModel(id: 'batch_password_gen', name: 'Batch Password Generator', description: 'Generate multiple passwords at once with configurable options.', category: ToolCategory.password, icon: Icons.format_list_bulleted, tags: ['batch', 'password', 'bulk'], isAvailable: true, routePath: '/category/password/batch'),
