...
class ToolsRegistry {
  ...
  static const List<ToolModel> all = [
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/crypto/hash_generator'),
    ToolModel(
        id: 'hmac_generator',
        name: 'HMAC Generator',
        description:
        ...
        isAvailable: true,
        routePath: '/category/crypto/hmac_generator'),
    ToolModel(
        id: 'hash_comparator',
        ...
        isAvailable: true,
        routePath: '/category/crypto/hash_comparator'),
    ToolModel(
        id: 'bcrypt_hash',
        name: 'Bcrypt Hash',
        description:
        ...
        isAvailable: true,
        routePath: '/category/crypto/bcrypt_hash'),
    ToolModel(
        id: 'argon2_hash',
        name: 'Argon2 Hash',
        ...
        isAvailable: true,
        routePath: '/category/crypto/argon2_hash'),
    ToolModel(
        id: 'salt_generator',
        name: 'Salt Generator',
        description:
        ...
        isAvailable: true,
        routePath: '/category/crypto/salt_generator'),
    ToolModel(
        id: 'blake2b_hash',
        name: 'BLAKE2b Hash',
    ...
    ToolModel(
        id: 'blake2s_hash',
        name: 'BLAKE2s Hash',
        description: 'BLAKE2s — optimized for 8 to 32-bit platforms.',
        category: ToolCategory.crypto,
        icon: Icons.fingerprint,
        tags: ['blake2', 'hash'],
        isAvailable: false),
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/crypto/crc_checksum'),
    ToolModel(
        id: 'adler32_checksum',
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/crypto/aes_tool'),
    ToolModel(
        id: 'rsa_tool',
        ...
        isAvailable: true,
        routePath: '/category/crypto/rsa_tool'),
    ToolModel(
        id: 'pbkdf2_tool',
        ...
        isAvailable: true,
        routePath: '/category/crypto/pbkdf2_tool'),
    ToolModel(
        id: 'chacha20_tool',
        ...
        isAvailable: true,
        routePath: '/category/crypto/chacha20_tool'),
    ToolModel(
        id: 'rsa_encrypt',
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/crypto/random_key_gen'),
    ToolModel(
        id: 'hkdf_tool',
    ...
    ToolModel(
        ...
        description:
            'Blowfish symmetric block cipher encryption and decryption.',
        category: ToolCategory.crypto,
        icon: Icons.lock_outline,
    ...
    ToolModel(
        ...
        description:
            'Parse and inspect X.509 certificates in PEM or DER format.',
        category: ToolCategory.crypto,
    ...
    ToolModel(
        ...
        description:
            'Sign messages and verify signatures using RSA/ECDSA keys.',
        category: ToolCategory.crypto,
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/password/password_generator'),
    ToolModel(
        id: 'entropy_analyzer',
        ...
        isAvailable: true,
        routePath: '/category/password/entropy_analyzer'),
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/password/passphrase_diceware'),
    ToolModel(
        id: 'pin_generator',
        name: 'PIN Generator',
        description:
        ...
        isAvailable: true,
        routePath: '/category/password/pin_generator'),
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/password/pronounceable'),
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/password/batch'),
    ToolModel(
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/password/password_history'),
    ...
    ToolModel(
        ...
        description:
            'Encode and decode Base64 (standard and URL-safe variants).',
        category: ToolCategory.encodeDecode,
        icon: Icons.swap_horiz,
        tags: ['base64', 'encode', 'decode'],
        isAvailable: true,
        routePath: '/category/encodeDecode/base64_tool'),
    ToolModel(
        id: 'base32_tool',
        ...
        isAvailable: true,
        routePath: '/category/encodeDecode/base32_tool'),
    ToolModel(
        id: 'hex_tool',
        ...
        isAvailable: true,
        routePath: '/category/encodeDecode/hex_tool'),
    ToolModel(
        id: 'url_encode_tool',
        ...
        isAvailable: true,
        routePath: '/category/encodeDecode/url_encode_tool'),
    ToolModel(
        id: 'rot_tool',
        name: 'ROT13 / ROT47',
        ...
        isAvailable: true,
        routePath: '/category/encodeDecode/rot_tool'),
    ToolModel(
        id: 'morse_tool',
        name: 'Morse Code',
        ...
        isAvailable: true,
        routePath: '/category/encodeDecode/morse_tool'),
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/encodeDecode/binary_octal_tool'),
    ToolModel(
        id: 'html_entities',
        name: 'HTML Entities',
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/encodeDecode/base58_tool'),
    ToolModel(
        id: 'base85_tool',
        name: 'Base85 (Ascii85)',
        description:
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/encodeDecode/xor_tool'),
    ToolModel(
        id: 'nato_alphabet',
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/network/ping_tool',
        requiresNetwork: true),
    ToolModel(
        id: 'dns_lookup',
        name: 'DNS Lookup',
        description:
            'Query DNS records: A, AAAA, MX, TXT, CNAME, NS, SOA, CAA.',
        category: ToolCategory.network,
        icon: Icons.dns_outlined,
        tags: ['dns', 'lookup', 'a', 'mx', 'txt'],
        isAvailable: true,
        routePath: '/category/network/dns_lookup',
        requiresNetwork: true),
    ToolModel(
        id: 'port_scanner',
        name: 'Port Scanner',
    ...
    ToolModel(
        ...
        description:
            'Look up PTR records to resolve IP addresses to hostnames.',
        category: ToolCategory.network,
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/wifi/wifi_scanner'),
    ToolModel(
        id: 'wifi_qr',
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/developer/json_tool'),
    ToolModel(
        id: 'json_yaml_tool',
        ...
        isAvailable: true,
        routePath: '/category/developer/json_yaml_tool'),
    ToolModel(
        id: 'jwt_decoder',
        name: 'JWT Decoder',
        description:
        ...
        isAvailable: true,
        routePath: '/category/developer/jwt_decoder'),
    ToolModel(
        id: 'regex_tester',
        name: 'Regex Tester',
        description:
        ...
        isAvailable: true,
        routePath: '/category/developer/regex_tester'),
    ToolModel(
        id: 'diff_tool',
        name: 'Diff Tool',
        description:
        ...
        isAvailable: true,
        routePath: '/category/developer/diff_tool'),
    ToolModel(
        id: 'cron_tool',
        name: 'CRON Explainer',
        description:
        ...
        isAvailable: true,
        routePath: '/category/developer/cron_tool'),
    ToolModel(
        id: 'timestamp_tool',
        ...
        isAvailable: true,
        routePath: '/category/developer/timestamp_tool'),
    ToolModel(
        id: 'uuid_generator',
        name: 'UUID Generator',
        description:
        ...
        isAvailable: true,
        routePath: '/category/developer/uuid_generator'),
    ToolModel(
        id: 'color_converter',
        ...
        isAvailable: true,
        routePath: '/category/developer/color_converter'),
    ToolModel(
        id: 'markdown_preview',
    ...
    ToolModel(
        ...
        description:
            'Generate RSA, ECDSA, and Ed25519 SSH key pairs (offline).',
        category: ToolCategory.encodingUtils,
        icon: Icons.terminal,
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/systemTools/system_info'),
    ToolModel(
        id: 'network_info',
    ...
    ToolModel(
        ...
        description:
            'Remove tracking parameters (UTM, fbclid, etc.) from URLs.',
        category: ToolCategory.osint,
        icon: Icons.link_off,
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/qrBarcode/qr_generator'),
    ToolModel(
        id: 'barcode_gen',
    ...
    ToolModel(
        ...
        isAvailable: true,
        routePath: '/category/qrBarcode/qr_analyzer'),
    ToolModel(
        id: 'qr_custom',
        ...
        isAvailable: true,
        routePath: '/category/qrBarcode/qr_custom'),
    ToolModel(
        id: 'qr_batch',
